...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Offers Received') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ url('/counselor/offer_received') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="semester" type="text" class="form-control" name="semester" required autocomplete="semester">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="in_date" type="date" class="form-control @error('in_date') is-invalid @enderror" name="in_date" required autocomplete="in_date">
