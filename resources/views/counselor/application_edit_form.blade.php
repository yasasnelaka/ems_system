            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <form method="POST" action="{{ url('/counselor/application_edit') }}" enctype="multipart/form-data">
                                {{ method_field('PUT') }}
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" value="{{$student->date_applied}}" name="date" required autocomplete="date">
